...
<div id="header" class="gainlayout">   
      <div id="logo" class="gainlayout">
         	<h2><a href="<?php echo JURI::base(); ?>" title="<?php echo htmlspecialchars($logoText); ?>"><img src="../images/logoCDR.png"/></a></h2>
			<h3></h3> 
      </div>
...
<div id="footerwrap" class="gainlayout" style="width:<?php echo $pageWidth + $outermargin; ?>px;"> 
  ...
  <div id="a4j"><a href="#">CDR La Safor - Centro de Desarrollo Rural</a></div>  
</div>
